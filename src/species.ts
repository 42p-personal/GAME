...
export const SPECIES: Species[] = [
  ...
  { id: 'pyraxon', name: 'Pyraxon', body: 'Draconic', naturalClass: 'Warrior', base: s(42, 20, 36, 20, 16, 10), lifespan: 8, flavour: 'Fire-breathing drake, ancient fury.',
  ...
  { id: 'frostwyren', name: 'Frostwyren', body: 'Draconic', naturalClass: 'Wizard', base: s(22, 22, 20, 30, 44, 6), lifespan: 8, flavour: 'Icy wyvern, patient mage.',
  ...
  { id: 'stormlerath', name: 'Stormlerath', body: 'Draconic', naturalClass: 'Ranger', base: s(26, 38, 20, 22, 32, 6), lifespan: 7, flavour: 'Lightning-winged serpent, swift strike.',
  ...
  { id: 'verdantdrake', name: 'Verdantdrake', body: 'Draconic', naturalClass: 'Sage', base: s(20, 18, 26, 40, 32, 8), lifespan: 9, flavour: 'Emerald dragon, nature\'s guardian.',
  ...
  { id: 'voidmaw', name: 'Voidmaw', body: 'Draconic', naturalClass: 'Wizard', base: s(22, 26, 20, 32, 38, 6), lifespan: 7, flavour: 'Void-touched dragon, cosmic terror.',
  ...
  { id: 'tenebrae', name: 'Tenebrae', body: 'Abyssal', naturalClass: 'Rogue', base: s(32, 42, 14, 22, 24, 10), lifespan: 7, flavour: 'Shadow squid, sneaky assassin.',
  ...
  { id: 'abyssomancer', name: 'Abyssomancer', body: 'Abyssal', naturalClass: 'Wizard', base: s(16, 30, 12, 34, 40, 12), lifespan: 8, flavour: 'Deep-sea sorceress, eldritch power.',
  ...
  { id: 'lurkerss', name: 'Lurkerss', body: 'Abyssal', naturalClass: 'Sage', base: s(14, 30, 14, 38, 34, 14), lifespan: 8, flavour: 'Luminescent serpent, deep thinker.',
  ...
  { id: 'chrono-leviathan', name: 'Chrono-Leviathan', body: 'Abyssal', naturalClass: 'Sage', base: s(16, 30, 12, 40, 38, 8), lifespan: 10, flavour: 'Time-warped colossus, ageless predator.',
  ...
  { id: 'cephalumbra', name: 'Cephalumbra', body: 'Abyssal', naturalClass: 'Rogue', base: s(32, 46, 12, 20, 24, 10), lifespan: 7, flavour: 'Phantom tentacles, ghost-swift.',
  ...
  { id: 'titanrex', name: 'Titanrex', body: 'Mythical', naturalClass: 'Warrior', base: s(60, 16, 50, 12, 12, 8), lifespan: 9, flavour: 'Primal tyrant lizard, raw power.',
  ...
  { id: 'stellarion', name: 'Stellarion', body: 'Mythical', naturalClass: 'Ranger', base: s(10, 52, 10, 32, 44, 10), lifespan: 8, flavour: 'Star-born hunter, celestial archer.',
  ...
  { id: 'wisdomkeeper', name: 'Wisdomkeeper', body: 'Mythical', naturalClass: 'Sage', base: s(12, 18, 20, 56, 44, 8), lifespan: 10, flavour: 'Ancient oracle, all-seeing guide.',
  ...
  { id: 'archmage-aleph', name: 'Archmage-Aleph', body: 'Mythical', naturalClass: 'Wizard', base: s(8, 20, 14, 40, 58, 18), lifespan: 8, flavour: 'First of mages, spell incarnate.',
  ...
  { id: 'harmonybringer', name: 'Harmonybringer', body: 'Mythical', naturalClass: 'Bard', base: s(10, 40, 28, 16, 10, 54), lifespan: 9, flavour: 'Mythical unifier, peace in chaos.',
