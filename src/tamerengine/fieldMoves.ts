...
export const MOVEMENT_MOVES: Move[] = [
  {
    ...
    channel: 'melee', target: 'enemy', cooldown: 4, accuracy: 90, power: 22,
  ...
  },
  {
    ...
    channel: 'support', target: 'self', cooldown: 5, accuracy: 100, power: 0,
  ...
  },
  {
    ...
    channel: 'melee', target: 'enemy', cooldown: 5, accuracy: 90, power: 18,
  ...
  },
  {
    ...
    channel: 'support', target: 'self', cooldown: 7, accuracy: 100, power: 0,
  ...
  },
  {
    ...
    channel: 'magic', target: 'self', cooldown: 6, accuracy: 100, power: 0,
  ...
  },
  {
    ...
    channel: 'voice', target: 'ally', cooldown: 6, accuracy: 100, power: 0,
...
export const ARENA_MOVES: Move[] = [
  // ── STR — brute geometry ──────────────────────────────────────────────────
  {
    ...
    channel: 'melee', target: 'enemy', cooldown: 5, accuracy: 85, power: 30,
  ...
  },
  {
    ...
    channel: 'melee', target: 'enemy', cooldown: 6, accuracy: 85, power: 34,
  ...
  // ── DEX — reach and repositioning ─────────────────────────────────────────
  {
    ...
    channel: 'melee', target: 'enemy', cooldown: 5, accuracy: 90, power: 26,
  ...
  },
  {
    ...
    channel: 'ranged', target: 'enemy', cooldown: 7, accuracy: 100, power: 0,
  ...
  // ── CON — holding ground ──────────────────────────────────────────────────
  {
    ...
    channel: 'melee', target: 'enemy', cooldown: 6, accuracy: 90, power: 24,
  ...
  },
  {
    ...
    channel: 'support', target: 'self', cooldown: 8, accuracy: 100, power: 0,
    range: 5, castTime: 0.5,
    spatial: { zone: { radius: 4.5, duration: 7, effect: 'heal', power: 7, centre: 'self' } },
  ...
  // ── WIS — denial and sanctuary ────────────────────────────────────────────
  {
    ...
    spatial: { zone: { radius: 4.2, duration: 8, effect: 'heal', power: 9, centre: 'self' } },
    desc: 'Consecrate the earth beneath your team.',
  },
  {
    id: 'FLD-WIS-2', name: 'Miasma', stat: 'WIS', learnLevel: 650, type: 'debuff',
    channel: 'magic', target: 'enemy', cooldown: 7, accuracy: 100, power: 0,
    range: 9, castTime: 0.5,
    spatial: { zone: { radius: 4, duration: 7, effect: 'damage', power: 8, centre: 'target' } },
  ...
  // ── INT — space itself ────────────────────────────────────────────────────
  {
    ...
    channel: 'magic', target: 'enemy', cooldown: 7, accuracy: 95, power: 12,
  ...
  // ── CHA — moving other people ─────────────────────────────────────────────
  {
    ...
    channel: 'voice', target: 'team', cooldown: 8, accuracy: 100, power: 0,
  ...
  },
  {
    ...
    channel: 'voice', target: 'enemy', cooldown: 6, accuracy: 90, power: 14,
