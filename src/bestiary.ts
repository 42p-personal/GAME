...
export const BIOS: Record<string, string> = {
  ...
  scarabrute: 'Spent a century as the keystone of a dam his colony built, holding back a river with his own shell. When the colony moved on he found the Circuit — the only place left where something is allowed to hit him as hard as the river did.',
  mantevoke: 'A temple garden’s silent guardian who meditated motionless between intruders for so long that stillness became his art. He competes to prove that the fight is decided before the first strike — one cut, perfectly placed, is his entire philosophy.',
  arachnyx: 'She has never once left her lair to fight — opponents are escorted in. Every match is played on her web, on her terms, and she regards footwork as a failure of preparation.',
  vespera: 'A queen whose hive grew so vast it no longer needed her orders. She entered the Circuit to feel needed again, and ten thousand loyal wings follow her into every arena anyway.',
  odonatra: 'Four wings, four directions, no patience. She flew through a tournament grounds by accident, dodged everything thrown at her on the way out, and came back the next season to do it on purpose.',
  crocmaw: 'Waited motionless in his river for so long that maps marked him as a sandbar. The Circuit is the first thing in decades that made him move — and the arena floor still shakes when he does.',
  iguanor: 'Deposed no one, conquered nothing — his warband simply formed around him because he looks magnificent on a sun-warmed rock. He competes to prove the crown he never asked for was deserved.',
  ...
  geckari: 'Grew up scaling the arena’s outer walls to watch matches for free, and knows every surface of every venue on the Circuit. Fights the way he watched — from angles nobody thinks to defend.',
