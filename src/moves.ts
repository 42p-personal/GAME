...
const POOLS: Record<Stat, Row[]> = {
  ...
  STR: [
    ...
    { name: 'Reckless Slam', learnLevel: 380, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 4, accuracy: 85, power: 63, mana: 26, variance: 0.25, element: 'fire', effects: { recoil: 0.1 }, desc: 'A scorching, reckless haymaker; it burns the arm that throws it.' },
    ...
    { name: 'Earthshaker', learnLevel: 650, type: 'damage', channel: 'melee', target: 'allEnemies', cooldown: 5, accuracy: 80, power: 66, mana: 40, variance: 0.25, element: 'earth', status: { kind: 'stun', chance: 30, duration: 1 }, desc: 'A shockwave that fells whatever is standing near it.' },
  ...
  INT: [
    ...
    { name: 'Ember', learnLevel: 40, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 2, accuracy: 90, power: 15, mana: 6, variance: 0.2, element: 'fire', status: { kind: 'burn', chance: 45, duration: 3 }, desc: 'Minor fire, and it catches. The cheapest way to start a stack.' },
    { name: 'Fracturing Stones', learnLevel: 120, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 2, accuracy: 90, power: 26, mana: 14, variance: 0.2, element: 'earth', status: { kind: 'vulnerable', chance: 40, duration: 3 }, desc: 'A stinging barrage that cracks the guard. The second stack type.' },
    { name: 'Cinderburst', learnLevel: 200, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 3, accuracy: 88, power: 40, mana: 20, variance: 0.15, element: 'fire', effects: { bonusVsStatus: { kind: 'burn', mult: 1.6, consume: true } }, desc: 'Solid on its own, and it snuffs a Burn for far more. The first detonator.' },
    ...
    { name: 'Frost Shard', learnLevel: 90, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 2, accuracy: 90, power: 25, mana: 12, variance: 0.2, element: 'water', desc: 'An icy dart. The frost line opens here.' },
    { name: 'Rime Bind', learnLevel: 160, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 3, accuracy: 90, power: 37, mana: 16, variance: 0.15, element: 'water', desc: 'Ice climbs the legs and sets. It can still cast; it is going nowhere.' },
    { name: 'Frost Nova', learnLevel: 280, type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 4, accuracy: 85, power: 34, mana: 26, variance: 0.2, element: 'water', desc: 'A ring of hoarfrost bursts outward — the anti-melee tool casters never had.' },
    ...
    { name: 'Inferno', learnLevel: 430, type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 4, accuracy: 82, power: 48, mana: 32, variance: 0.25, element: 'fire', status: { kind: 'burn', chance: 30, duration: 3 }, desc: 'Fire across the whole position, and much of it keeps burning.' },
    { name: 'Seismic Crush', learnLevel: 560, type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 5, accuracy: 82, power: 58, mana: 38, variance: 0.25, element: 'earth', status: { kind: 'stun', chance: 30, duration: 1 }, desc: 'The ground itself comes up. Damage AND a stun on everything standing on it.' },
    { name: 'World Ender', learnLevel: 920, type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 7, accuracy: 78, power: 119, mana: 56, variance: 0.3, element: 'earth', effects: { maxHpDmg: 0.02 }, desc: 'The largest thing in the game, and it hurts the biggest of them most.' },

    // ── Arcanist — move things. Yourself, or them ────────────────────────────
    { name: 'Spark', learnLevel: 40, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 1, accuracy: 95, power: 17, mana: 5, variance: 0.15, element: 'air', desc: 'A small air bolt, cheap enough to throw between everything else.' },
    ...
    { name: 'Static Chain', learnLevel: 330, type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 4, accuracy: 85, power: 42, mana: 28, variance: 0.2, element: 'air', status: { kind: 'vulnerable', chance: 25, duration: 2 }, desc: 'A bolt that leaps body to body along a line, weakening as it goes.' },
