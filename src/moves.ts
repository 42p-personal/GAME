...
const POOLS: Record<Stat, Row[]> = {
  ...
  INT: [
    { name: 'Spark', type: 'damage', channel: 'magic', target: 'enemy', cooldown: 1, accuracy: 95, power: 12, desc: 'Small elemental bolt.' },
    { name: 'Ember', type: 'damage', channel: 'magic', target: 'enemy', cooldown: 2, accuracy: 90, power: 14, status: { kind: 'burn', chance: 70, duration: 3 }, desc: 'Minor fire damage; applies Burn.' },
    { name: 'Frost Shard', type: 'damage', channel: 'magic', target: 'enemy', cooldown: 2, accuracy: 90, power: 20, desc: 'Elemental hit that slows.' },
    { name: 'Shock', type: 'damage', channel: 'magic', target: 'enemy', cooldown: 3, accuracy: 88, power: 22, status: { kind: 'stun', chance: 30, duration: 1 }, desc: 'Elemental hit with stun chance.' },
    { name: 'Fireball', type: 'damage', channel: 'magic', target: 'enemy', cooldown: 3, accuracy: 88, power: 30, desc: 'Solid single-target elemental burst.' },
    { name: 'Ice Lance', type: 'damage', channel: 'magic', target: 'enemy', cooldown: 3, accuracy: 85, power: 34, desc: 'High elemental damage, pierces.' },
    { name: 'Chain Lightning', type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 4, accuracy: 85, power: 26, desc: 'Elemental bolt bouncing between foes.' },
    { name: 'Inferno', type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 4, accuracy: 82, power: 28, status: { kind: 'burn', chance: 60, duration: 3 }, desc: 'Fire AoE; applies Burn.' },
    { name: 'Blizzard', type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 5, accuracy: 80, power: 34, desc: 'Elemental AoE + freeze.' },
    { name: 'Meteor', type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 6, accuracy: 78, power: 52, desc: 'Massive elemental AoE nuke.' },
  ],
  CHA: [
