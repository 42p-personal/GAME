...
const POOLS: Record<Stat, Row[]> = {
  ...
  DEX: [
    ...
    { name: 'Piercing Shot', learnLevel: 90, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 2, accuracy: 90, power: 18, effects: { hits: [1, 2], spreadStatus: { kind: 'poison', targets: 1, chance: 20 } }, status: { kind: 'poison', chance: 45, duration: 3 }, desc: 'One or two venom-tipped shots; 45% chance to Poison, and the venom may pass to another.' },
    ...
    { name: 'Pin Down', learnLevel: 200, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 3, accuracy: 88, power: 29, effects: { accDebuff: 10, duration: 3 }, desc: 'Suppressing fire: target aims worse for 3 rounds.' },
    ...
    { name: 'Rain of Arrows', learnLevel: 650, type: 'damage', channel: 'ranged', target: 'backRow', cooldown: 4, accuracy: 82, power: 46, element: 'air', status: { kind: 'knockback', chance: 20, duration: 2 }, desc: 'A volley arced clean over the front line onto whoever hides behind it; 20% knockback.' },
    { name: 'Shadow Barrage', learnLevel: 780, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 5, accuracy: 88, power: 13, effects: { hits: [3, 6], randomTargets: true }, desc: 'A storm of strikes from cover, 3–6 hits sprayed across whoever is standing.' },
    { name: 'Heartseeker', learnLevel: 850, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 4, accuracy: 92, power: 15, effects: { hits: [2, 3], execute: 0.4 }, desc: 'A homing volley, 2–3 shots, 1.5× vs weakened foes.' },
