...
const POOLS: Record<Stat, Row[]> = {
  ...
  STR: [
    ...
    { name: 'Blood Price', learnLevel: 240, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 3, accuracy: 90, power: 32, mana: 10, variance: 0.2, effects: { recoil: 0.1 }, desc: 'Swung with everything, including what it costs you. Cheap in mana because it is paid for in blood.' },
    { name: 'Reckless Slam', learnLevel: 380, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 4, accuracy: 85, power: 46, mana: 26, variance: 0.25, element: 'fire', effects: { recoil: 0.1 }, desc: 'A scorching, reckless haymaker; it burns the arm that throws it.' },
    ...
    { name: 'Blood Fury', learnLevel: 700, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 3, accuracy: 88, power: 27, mana: 24, variance: 0.3, effects: { hpScale: { atFull: 0.5, atEmpty: 2.1 } }, desc: 'Feeble while it is still whole, and terrifying once it is not — this blow feeds on its own wounds.' },
    { name: 'Titanfall', learnLevel: 920, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 6, accuracy: 80, power: 65, mana: 52, variance: 0.25, effects: { pierce: 0.3, recoil: 0.15 }, desc: 'Colossal blow that partly ignores defence; 15% recoil.' },
    ...
    { name: 'Power Strike', learnLevel: 90, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 2, accuracy: 90, power: 25, mana: 16, variance: 0.1, effects: { recoil: 0.05 }, desc: 'A heavy, committed blow, thrown exactly where it was aimed.' },
    ...
    { name: 'Headbutt', learnLevel: 300, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 3, accuracy: 90, power: 26, mana: 16, variance: 0.15, status: { kind: 'stun', chance: 30, duration: 1 }, desc: 'Short, ugly, and it rings their bell.' },
    { name: 'Bonebreaker', learnLevel: 330, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 4, accuracy: 85, power: 29, mana: 22, variance: 0.15, effects: { defDebuff: 8, duration: 3 }, status: { kind: 'vulnerable', chance: 45, duration: 2 }, desc: 'Shatters defence and leaves them open — the opener Executioner is waiting on.' },
    { name: 'Rend', learnLevel: 480, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 3, accuracy: 85, power: 23, mana: 18, variance: 0.15, status: { kind: 'bleed', chance: 55, duration: 3 }, desc: 'Opens a wound that keeps opening. Bleed here; Bonebreaker handles armour.' },
    ...
    { name: 'Executioner', learnLevel: 850, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 4, accuracy: 90, power: 34, mana: 28, variance: 0.1, effects: { execute: 0.35, bonusVsStatus: { kind: 'vulnerable', mult: 1.8, consume: true } }, desc: 'The closing blow: brutal against the weakened, and devastating against the Vulnerable.' },
    ...
    { name: 'Cleave', learnLevel: 160, type: 'damage', channel: 'melee', target: 'allEnemies', cooldown: 3, accuracy: 85, power: 27, mana: 22, variance: 0.2, desc: 'A horizontal sweep through everything in front of it — weak into one body, brutal into three.' },
    ...
    { name: 'Whirlwind', learnLevel: 600, type: 'damage', channel: 'melee', target: 'allEnemies', cooldown: 4, accuracy: 88, power: 32, mana: 34, variance: 0.2, desc: 'Spins through everything within reach. Pure volume, no rider.' },
    { name: 'Earthshaker', learnLevel: 650, type: 'damage', channel: 'melee', target: 'allEnemies', cooldown: 5, accuracy: 80, power: 40, mana: 40, variance: 0.25, element: 'earth', status: { kind: 'stun', chance: 30, duration: 1 }, desc: 'A shockwave that fells whatever is standing near it.' },
  ...
  DEX: [
    ...
    { name: 'Shadowstep', learnLevel: 120, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 4, accuracy: 92, power: 42, mana: 16, variance: 0.15, desc: 'Steps through the shadow behind them. The only reliable way past a front line.' },
    { name: 'Ambush', learnLevel: 200, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 3, accuracy: 92, power: 36, mana: 18, variance: 0.2, effects: { firstStrikeMult: 1.5 }, desc: 'Devastating on someone who has not swung yet — worthless once they have seen you.' },
    ...
    { name: 'Hamstring', learnLevel: 420, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 3, accuracy: 90, power: 36, mana: 16, variance: 0.15, desc: 'Cuts the leg out from under them. They keep fighting; they stop leaving.' },
    { name: 'Throat Cut', learnLevel: 600, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 5, accuracy: 90, power: 50, mana: 30, variance: 0.1, status: { kind: 'silence', chance: 55, duration: 2 }, desc: 'Quiet, precise, and it ends the casting. What the Assassin line exists to do.' },
    { name: 'Heartseeker', learnLevel: 850, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 4, accuracy: 92, power: 21, mana: 26, variance: 0.3, effects: { hits: [2, 3], execute: 0.35 }, desc: 'Two or three finding strikes, lethal against anything already failing.' },

    // ── Venomcraft — put poison on, keep it there, then detonate it ───────────
    { name: 'Piercing Shot', learnLevel: 90, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 2, accuracy: 90, power: 25, mana: 14, variance: 0.2, effects: { hits: [1, 2], spreadStatus: { kind: 'poison', targets: 1, chance: 20 } }, status: { kind: 'poison', chance: 45, duration: 3 }, desc: 'One or two venom-tipped shots, and the venom may pass to a neighbour.' },
    { name: 'Toxin Stack', learnLevel: 180, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 2, accuracy: 92, power: 25, mana: 10, variance: 0.15, status: { kind: 'poison', chance: 70, duration: 4 }, desc: 'A cheap second dose. Poison is the point; the dart barely matters.' },
    { name: 'Twin Fangs', learnLevel: 280, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 2, accuracy: 90, power: 15, mana: 14, variance: 0.25, effects: { hits: [2, 2] }, status: { kind: 'bleed', chance: 35, duration: 3 }, desc: 'Two quick shots that open a wound — bleed here, poison everywhere else in the line.' },
    { name: 'Paralytic Dart', learnLevel: 400, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 4, accuracy: 90, power: 42, mana: 22, variance: 0.15, status: { kind: 'stun', chance: 35, duration: 1 }, desc: "DEX's one hard control: a neurotoxin that drops them where they stand." },
    { name: 'Virulence', learnLevel: 560, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 5, accuracy: 90, power: 36, mana: 20, variance: 0.2, effects: { bonusVsStatus: { kind: 'poison', mult: 2.6, consume: true } }, desc: 'Feeble on clean blood, ruinous on poisoned — the payoff the whole line builds toward.' },
    { name: 'Plague Shot', learnLevel: 740, type: 'damage', channel: 'ranged', target: 'allEnemies', cooldown: 5, accuracy: 85, power: 28, mana: 34, variance: 0.2, effects: { spreadStatus: { kind: 'poison', targets: 2, chance: 40 } }, status: { kind: 'poison', chance: 55, duration: 4 }, desc: 'Poison that jumps between bodies. It rewards an enemy that stands together.' },
    ...
    { name: 'Pin Down', learnLevel: 330, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 3, accuracy: 88, power: 39, mana: 18, variance: 0.15, desc: 'Suppressing fire that drags them out of position and holds them there.' },
    ...
    { name: 'Ricochet', learnLevel: 500, type: 'damage', channel: 'ranged', target: 'allEnemies', cooldown: 4, accuracy: 88, power: 25, mana: 26, variance: 0.3, effects: { hits: [1, 2] }, desc: 'One shot, several bodies. It bounces, and it does not much care whose.' },
    { name: 'Rain of Arrows', learnLevel: 650, type: 'damage', channel: 'ranged', target: 'allEnemies', cooldown: 5, accuracy: 85, power: 34, mana: 34, variance: 0.25, desc: 'A bombardment onto a chosen patch of ground — it punishes standing together.' },
    { name: 'Pinning Volley', learnLevel: 680, type: 'damage', channel: 'ranged', target: 'allEnemies', cooldown: 5, accuracy: 88, power: 31, mana: 32, variance: 0.2, desc: 'Nails several of them to the spot at once.' },
    ...
    { name: 'Deadeye', learnLevel: 920, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 6, accuracy: 95, power: 73, mana: 44, variance: 0.05, desc: 'One shot. It goes exactly where it was sent.' },
  ],
  ...
  CON: [
    ...
    { name: 'Body Slam', learnLevel: 140, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 2, accuracy: 90, power: 18, mana: 14, variance: 0.2, status: { kind: 'knockback', chance: 45, duration: 2 }, desc: 'Throws its bulk into them and sends them reeling.' },
    { name: 'Seize', learnLevel: 160, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 3, accuracy: 90, power: 16, mana: 14, variance: 0.15, desc: 'Clamps on and hauls them in. They can still fight; they cannot leave.' },
    ...
    { name: 'Quagmire Stomp', learnLevel: 300, type: 'damage', channel: 'melee', target: 'allEnemies', cooldown: 5, accuracy: 85, power: 20, mana: 30, variance: 0.2, status: { kind: 'knockback', chance: 45, duration: 2 }, desc: 'Churns the footing out from under the whole line.' },
    ...
    { name: 'Tremor', learnLevel: 460, type: 'damage', channel: 'melee', target: 'allEnemies', cooldown: 4, accuracy: 88, power: 18, mana: 28, variance: 0.2, desc: 'The ground shudders. Everything nearby is slowed and staggered.' },
    ...
    { name: 'Crushing Grip', learnLevel: 620, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 4, accuracy: 90, power: 25, mana: 26, variance: 0.15, desc: 'Takes hold and squeezes. It is not going anywhere while this lasts.' },
    { name: 'Earthen Grasp', learnLevel: 700, type: 'damage', channel: 'melee', target: 'allEnemies', cooldown: 6, accuracy: 85, power: 18, mana: 36, variance: 0.15, desc: 'Stone closes on every ankle in reach. The Warden capstone: nobody leaves.' },
    ...
    { name: 'Overrun', learnLevel: 280, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 3, accuracy: 88, power: 21, mana: 18, variance: 0.2, status: { kind: 'knockback', chance: 40, duration: 2 }, desc: 'Charges straight through: damage and a shove, paid for with momentum.' },
    { name: 'Shell Slam', learnLevel: 380, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 3, accuracy: 85, power: 23, mana: 22, variance: 0.2, effects: { recoil: 0.1, hpScale: { atFull: 1.4, atEmpty: 0.8 } }, desc: 'Hits hardest while the shell is whole, and fades as its own health fails.' },
    ...
    { name: 'Colossus Crash', learnLevel: 850, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 5, accuracy: 85, power: 30, mana: 32, variance: 0.2, effects: { guard: 10, maxHpDmg: 0.03, consumeWard: 0.015 }, desc: 'A crushing advance that braces after the blow; the bigger they are, the more it takes.' },
  ],
  ...
  INT: [
    ...
    { name: 'Fracturing Stones', learnLevel: 120, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 2, accuracy: 90, power: 24, mana: 14, variance: 0.2, element: 'earth', status: { kind: 'vulnerable', chance: 40, duration: 3 }, desc: 'A stinging barrage that cracks the guard. The second stack type.' },
    { name: 'Cinderburst', learnLevel: 200, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 3, accuracy: 88, power: 34, mana: 20, variance: 0.15, element: 'fire', effects: { bonusVsStatus: { kind: 'burn', mult: 1.6, consume: true } }, desc: 'Solid on its own, and it snuffs a Burn for far more. The first detonator.' },
    ...
    { name: 'Arcane Bomb', learnLevel: 340, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 4, accuracy: 88, power: 41, mana: 26, variance: 0.2, effects: { bonusVsStatus: { kind: 'vulnerable', mult: 1.7, consume: true } }, desc: 'A charge left ticking on them — devastating on anything already cracked open.' },
    ...
    { name: 'Detonate', learnLevel: 700, type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 5, accuracy: 85, power: 32, mana: 38, variance: 0.25, effects: { bonusVsStatus: { kind: 'burn', mult: 2.0, consume: true } }, desc: 'Sets off everything still burning, on everyone at once. The Hexer capstone.' },

    // ── Elementalist — ground you cannot stand on ────────────────────────────
    { name: 'Frost Shard', learnLevel: 90, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 2, accuracy: 90, power: 24, mana: 12, variance: 0.2, element: 'water', desc: 'An icy dart. The frost line opens here.' },
    { name: 'Rime Bind', learnLevel: 160, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 3, accuracy: 90, power: 33, mana: 16, variance: 0.15, element: 'water', desc: 'Ice climbs the legs and sets. It can still cast; it is going nowhere.' },
    { name: 'Frost Nova', learnLevel: 280, type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 4, accuracy: 85, power: 27, mana: 26, variance: 0.2, element: 'water', desc: 'A ring of hoarfrost bursts outward — the anti-melee tool casters never had.' },
    ...
    { name: 'Inferno', learnLevel: 430, type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 4, accuracy: 82, power: 34, mana: 32, variance: 0.25, element: 'fire', status: { kind: 'burn', chance: 30, duration: 3 }, desc: 'Fire across the whole position, and much of it keeps burning.' },
    { name: 'Seismic Crush', learnLevel: 560, type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 5, accuracy: 82, power: 37, mana: 38, variance: 0.25, element: 'earth', status: { kind: 'stun', chance: 30, duration: 1 }, desc: 'The ground itself comes up. Damage AND a stun on everything standing on it.' },
    { name: 'World Ender', learnLevel: 920, type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 7, accuracy: 78, power: 61, mana: 56, variance: 0.3, element: 'earth', effects: { maxHpDmg: 0.02 }, desc: 'The largest thing in the game, and it hurts the biggest of them most.' },
    ...
    { name: 'Static Chain', learnLevel: 330, type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 4, accuracy: 85, power: 32, mana: 28, variance: 0.2, element: 'air', status: { kind: 'vulnerable', chance: 25, duration: 2 }, desc: 'A bolt that leaps body to body along a line, weakening as it goes.' },
    { name: 'Mana Leech', learnLevel: 380, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 3, accuracy: 88, power: 35, mana: 22, variance: 0.15, effects: { manaBurn: 14, lifesteal: 0.25 }, desc: 'Siphons and steps away in the same motion. WIS steals better; this one escapes.' },
    ...
    { name: 'Displace', learnLevel: 640, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 4, accuracy: 90, power: 33, mana: 26, variance: 0.15, desc: 'Teleports the TARGET — rips a diver out of your back line and pins it where it lands.' },
    { name: 'Void Lance', learnLevel: 780, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 5, accuracy: 85, power: 54, mana: 38, variance: 0.1, effects: { pierce: 0.5 }, desc: 'Pure void. Half of everything they are wearing simply does not apply.' },
    { name: 'Arcane Overload', learnLevel: 850, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 6, accuracy: 85, power: 61, mana: 44, variance: 0.3, effects: { recoil: 0.15 }, desc: 'Overchannelled past what the caster can hold. It burns them too.' },
  ],
  ...
  CHA: [
    ...
    { name: 'Screech', learnLevel: 160, type: 'damage', channel: 'voice', target: 'allEnemies', cooldown: 3, accuracy: 85, power: 12, mana: 22, variance: 0.2, status: { kind: 'fear', chance: 30, duration: 2 }, desc: 'A sound that routs. Hard control across a whole line.' },
    { name: 'Sonic Boom', learnLevel: 380, type: 'damage', channel: 'voice', target: 'enemy', cooldown: 4, accuracy: 85, power: 25, mana: 26, variance: 0.2, status: { kind: 'confusion', chance: 40, duration: 2 }, effects: { spreadStatus: { kind: 'confusion', targets: 1, chance: 30 } }, desc: 'A heavy burst, and the disorientation carries to whoever stood too close.' },
    ...
    { name: 'Cacophony', learnLevel: 650, type: 'damage', channel: 'voice', target: 'allEnemies', cooldown: 5, accuracy: 82, power: 22, mana: 36, variance: 0.25, status: { kind: 'charm', chance: 22, duration: 2 }, desc: 'A charmed foe turns on its own team. The best status in the game, and the rarest.' },
    ...
    { name: 'Captivate', learnLevel: 200, type: 'damage', channel: 'voice', target: 'enemy', cooldown: 3, accuracy: 88, power: 16, mana: 14, variance: 0.2, effects: { lifesteal: 0.45 }, desc: 'Feeds on adoration and gives nothing back.' },
    ...
    { name: 'Showstopper', learnLevel: 850, type: 'damage', channel: 'voice', target: 'enemy', cooldown: 5, accuracy: 88, power: 31, mana: 36, variance: 0.15, effects: { execute: 0.35 }, desc: 'The closing number, and it closes them.' },
    { name: 'Crescendo', learnLevel: 920, type: 'damage', channel: 'voice', target: 'allEnemies', cooldown: 7, accuracy: 80, power: 37, mana: 50, variance: 0.25, desc: 'A voice AoE finisher. CHA damage exists — it is just rare, and it is late.' },
  ],
}
