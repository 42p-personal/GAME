...
const POOLS: Record<Stat, Row[]> = {
  ...
  STR: [
    ...
    { name: 'Scrap', learnLevel: 40, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 1, accuracy: 95, power: 14, mana: 4, variance: 0.15, desc: 'A cheap, scrappy swing — what you throw while the rage builds.' },
    ...
    { name: 'Blood Price', learnLevel: 240, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 3, accuracy: 90, power: 39, mana: 10, variance: 0.2, effects: { recoil: 0.1 }, desc: 'Swung with everything, including what it costs you. Cheap in mana because it is paid for in blood.' },
    { name: 'Reckless Slam', learnLevel: 380, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 4, accuracy: 85, power: 63, mana: 26, variance: 0.25, effects: { recoil: 0.1 }, desc: 'A scorching, reckless haymaker; it burns the arm that throws it.' },
    ...
    { name: 'Blood Fury', learnLevel: 700, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 3, accuracy: 88, power: 46, mana: 24, variance: 0.3, effects: { hpScale: { atFull: 0.5, atEmpty: 2.1 } }, desc: 'Feeble while it is still whole, and terrifying once it is not — this blow feeds on its own wounds.' },
    { name: 'Titanfall', learnLevel: 920, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 6, accuracy: 80, power: 127, mana: 52, variance: 0.25, effects: { pierce: 0.3, recoil: 0.15 }, desc: 'Colossal blow that partly ignores defence; 15% recoil.' },
    ...
    { name: 'Cleave', learnLevel: 160, type: 'damage', channel: 'melee', target: 'allEnemies', cooldown: 3, accuracy: 85, power: 30, mana: 22, variance: 0.2, desc: 'A horizontal sweep through everything in front of it — weak into one body, brutal into three.' },
    ...
    { name: 'Whirlwind', learnLevel: 600, type: 'damage', channel: 'melee', target: 'allEnemies', cooldown: 4, accuracy: 88, power: 51, mana: 34, variance: 0.2, desc: 'Spins through everything within reach. Pure volume, no rider.' },
    { name: 'Earthshaker', learnLevel: 650, type: 'damage', channel: 'melee', target: 'allEnemies', cooldown: 5, accuracy: 80, power: 66, mana: 40, variance: 0.25, status: { kind: 'stun', chance: 30, duration: 1 }, desc: 'A shockwave that fells whatever is standing near it.' },
  ...
  DEX: [
    ...
    { name: 'Shadowstep', learnLevel: 120, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 4, accuracy: 92, power: 46, mana: 16, variance: 0.15, desc: 'Steps through the shadow behind them. The only reliable way past a front line.' },
    { name: 'Ambush', learnLevel: 200, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 3, accuracy: 92, power: 42, mana: 18, variance: 0.2, effects: { firstStrikeMult: 1.5 }, desc: 'Devastating on someone who has not swung yet — worthless once they have seen you.' },
    ...
    { name: 'Hamstring', learnLevel: 420, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 3, accuracy: 90, power: 51, mana: 16, variance: 0.15, desc: 'Cuts the leg out from under them. They keep fighting; they stop leaving.' },
    { name: 'Throat Cut', learnLevel: 600, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 5, accuracy: 90, power: 80, mana: 30, variance: 0.1, status: { kind: 'silence', chance: 55, duration: 2 }, desc: 'Quiet, precise, and it ends the casting. What the Assassin line exists to do.' },
    { name: 'Heartseeker', learnLevel: 850, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 4, accuracy: 92, power: 39, mana: 26, variance: 0.3, effects: { hits: [2, 3], execute: 0.35 }, desc: 'Two or three finding strikes, lethal against anything already failing.' },
    ...
    { name: 'Sling', learnLevel: 40, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 1, accuracy: 95, power: 14, mana: 5, variance: 0.3, effects: { hits: [1, 2] }, desc: 'One or two quick shots. Cheap enough to throw all day.' },
    ...
    { name: 'Pin Down', learnLevel: 330, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 3, accuracy: 88, power: 51, mana: 18, variance: 0.15, desc: 'Suppressing fire that drags them out of position and holds them there.' },
    ...
    { name: 'Ricochet', learnLevel: 500, type: 'damage', channel: 'ranged', target: 'allEnemies', cooldown: 4, accuracy: 88, power: 37, mana: 26, variance: 0.3, effects: { hits: [1, 2] }, desc: 'One shot, several bodies. It bounces, and it does not much care whose.' },
    { name: 'Rain of Arrows', learnLevel: 650, type: 'damage', channel: 'ranged', target: 'allEnemies', cooldown: 5, accuracy: 85, power: 56, mana: 34, variance: 0.25, desc: 'A bombardment onto a chosen patch of ground — it punishes standing together.' },
    { name: 'Pinning Volley', learnLevel: 680, type: 'damage', channel: 'ranged', target: 'allEnemies', cooldown: 5, accuracy: 88, power: 52, mana: 32, variance: 0.2, desc: 'Nails several of them to the spot at once.' },
    ...
    { name: 'Deadeye', learnLevel: 920, type: 'damage', channel: 'ranged', target: 'enemy', cooldown: 6, accuracy: 95, power: 142, mana: 44, variance: 0.05, desc: 'One shot. It goes exactly where it was sent.' },
  ],
  ...
  CON: [
    ...
    { name: 'Body Slam', learnLevel: 140, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 2, accuracy: 90, power: 19, mana: 14, variance: 0.2, status: { kind: 'knockback', chance: 45, duration: 2 }, desc: 'Throws its bulk into them and sends them reeling.' },
    { name: 'Seize', learnLevel: 160, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 3, accuracy: 90, power: 17, mana: 14, variance: 0.15, desc: 'Clamps on and hauls them in. They can still fight; they cannot leave.' },
    ...
    { name: 'Quagmire Stomp', learnLevel: 300, type: 'damage', channel: 'melee', target: 'allEnemies', cooldown: 5, accuracy: 85, power: 23, mana: 30, variance: 0.2, status: { kind: 'knockback', chance: 45, duration: 2 }, desc: 'Churns the footing out from under the whole line.' },
    ...
    { name: 'Tremor', learnLevel: 460, type: 'damage', channel: 'melee', target: 'allEnemies', cooldown: 4, accuracy: 88, power: 23, mana: 28, variance: 0.2, desc: 'The ground shudders. Everything nearby is slowed and staggered.' },
    ...
    { name: 'Crushing Grip', learnLevel: 620, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 4, accuracy: 90, power: 34, mana: 26, variance: 0.15, desc: 'Takes hold and squeezes. It is not going anywhere while this lasts.' },
    { name: 'Earthen Grasp', learnLevel: 700, type: 'damage', channel: 'melee', target: 'allEnemies', cooldown: 6, accuracy: 85, power: 25, mana: 36, variance: 0.15, desc: 'Stone closes on every ankle in reach. The Warden capstone: nobody leaves.' },
    ...
    { name: 'Overrun', learnLevel: 280, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 3, accuracy: 88, power: 24, mana: 18, variance: 0.2, status: { kind: 'knockback', chance: 40, duration: 2 }, desc: 'Charges straight through: damage and a shove, paid for with momentum.' },
    ...
    { name: 'Colossus Crash', learnLevel: 850, type: 'damage', channel: 'melee', target: 'enemy', cooldown: 5, accuracy: 85, power: 45, mana: 32, variance: 0.2, effects: { guard: 10, maxHpDmg: 0.03, consumeWard: 0.015 }, desc: 'A crushing advance that braces after the blow; the bigger they are, the more it takes.' },
  ],
  ...
  WIS: [
    ...
    { name: 'Silencing Spike', learnLevel: 200, type: 'damage', channel: 'support', target: 'enemy', cooldown: 2, accuracy: 90, power: 22, mana: 18, variance: 0.15, effects: { manaBurn: 13 }, status: { kind: 'silence', chance: 30, duration: 2 }, desc: 'A psychic jab that drinks 13 MP and can close the throat entirely.' },
    { name: 'Wither', learnLevel: 300, type: 'damage', channel: 'support', target: 'enemy', cooldown: 4, accuracy: 90, power: 23, mana: 20, variance: 0.15, effects: { lifesteal: 0.25, manaBurn: 10 }, desc: 'Saps them round on round and feeds you what it takes.' },
    ...
    { name: 'Mind Crush', learnLevel: 780, type: 'damage', channel: 'support', target: 'enemy', cooldown: 5, accuracy: 85, power: 50, mana: 34, variance: 0.15, effects: { manaBurn: 25, bonusVsStatus: { kind: 'doom', mult: 1.8, consume: true } }, desc: 'A heavy psychic blow that detonates their Doom early. The payoff.' },
    ...
    { name: 'Mind Spike', learnLevel: 140, type: 'damage', channel: 'support', target: 'enemy', cooldown: 2, accuracy: 92, power: 19, mana: 8, variance: 0.15, desc: 'A cheap psychic jab — the filler WIS never had and could never afford.' },
    ...
    { name: 'Drain Spirit', learnLevel: 380, type: 'damage', channel: 'support', target: 'enemy', cooldown: 4, accuracy: 88, power: 29, mana: 20, variance: 0.15, effects: { manaBurn: 15, lifesteal: 0.35 }, desc: 'Takes both at once — their mana, and a share of their blood.' },
    { name: 'Spirit Siphon', learnLevel: 600, type: 'damage', channel: 'support', target: 'enemy', cooldown: 5, accuracy: 88, power: 43, mana: 30, variance: 0.2, effects: { manaBurn: 20, lifesteal: 0.4 }, desc: 'Holds on and drains, HP and MP together, for as long as it lasts.' },
    { name: 'Judgement', learnLevel: 820, type: 'damage', channel: 'support', target: 'enemy', cooldown: 6, accuracy: 88, power: 65, mana: 38, variance: 0.2, desc: 'A real capstone HIT rather than one more aura. WIS can end things too.' },
  ...
  INT: [
    ...
    { name: 'Ember', learnLevel: 40, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 2, accuracy: 90, power: 15, mana: 6, variance: 0.2, status: { kind: 'burn', chance: 45, duration: 3 }, desc: 'Minor fire, and it catches. The cheapest way to start a stack.' },
    { name: 'Fracturing Stones', learnLevel: 120, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 2, accuracy: 90, power: 26, mana: 14, variance: 0.2, status: { kind: 'vulnerable', chance: 40, duration: 3 }, desc: 'A stinging barrage that cracks the guard. The second stack type.' },
    { name: 'Cinderburst', learnLevel: 200, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 3, accuracy: 88, power: 40, mana: 20, variance: 0.15, effects: { bonusVsStatus: { kind: 'burn', mult: 1.6, consume: true } }, desc: 'Solid on its own, and it snuffs a Burn for far more. The first detonator.' },
    ...
    { name: 'Arcane Bomb', learnLevel: 340, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 4, accuracy: 88, power: 54, mana: 26, variance: 0.2, effects: { bonusVsStatus: { kind: 'vulnerable', mult: 1.7, consume: true } }, desc: 'A charge left ticking on them — devastating on anything already cracked open.' },
    ...
    { name: 'Detonate', learnLevel: 700, type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 5, accuracy: 85, power: 55, mana: 38, variance: 0.25, effects: { bonusVsStatus: { kind: 'burn', mult: 2.0, consume: true } }, desc: 'Sets off everything still burning, on everyone at once. The Hexer capstone.' },
    ...
    { name: 'Spark', learnLevel: 40, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 1, accuracy: 95, power: 17, mana: 5, variance: 0.15, desc: 'A small air bolt, cheap enough to throw between everything else.' },
    ...
    { name: 'Static Chain', learnLevel: 330, type: 'damage', channel: 'magic', target: 'allEnemies', cooldown: 4, accuracy: 85, power: 42, mana: 28, variance: 0.2, status: { kind: 'vulnerable', chance: 25, duration: 2 }, desc: 'A bolt that leaps body to body along a line, weakening as it goes.' },
    { name: 'Mana Leech', learnLevel: 380, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 3, accuracy: 88, power: 48, mana: 22, variance: 0.15, effects: { manaBurn: 14, lifesteal: 0.25 }, desc: 'Siphons and steps away in the same motion. WIS steals better; this one escapes.' },
    ...
    { name: 'Displace', learnLevel: 640, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 4, accuracy: 90, power: 54, mana: 26, variance: 0.15, desc: 'Teleports the TARGET — rips a diver out of your back line and pins it where it lands.' },
    { name: 'Void Lance', learnLevel: 780, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 5, accuracy: 85, power: 97, mana: 38, variance: 0.1, effects: { pierce: 0.5 }, desc: 'Pure void. Half of everything they are wearing simply does not apply.' },
    { name: 'Arcane Overload', learnLevel: 850, type: 'damage', channel: 'magic', target: 'enemy', cooldown: 6, accuracy: 85, power: 114, mana: 44, variance: 0.3, effects: { recoil: 0.15 }, desc: 'Overchannelled past what the caster can hold. It burns them too.' },
  ],
  ...
  CHA: [
    ...
    { name: 'Discord', learnLevel: 40, type: 'damage', channel: 'voice', target: 'enemy', cooldown: 2, accuracy: 90, power: 13, mana: 8, variance: 0.2, status: { kind: 'blind', chance: 50, duration: 3 }, desc: 'A jarring note that leaves them swinging at afterimages.' },
    { name: 'Screech', learnLevel: 160, type: 'damage', channel: 'voice', target: 'allEnemies', cooldown: 3, accuracy: 85, power: 13, mana: 22, variance: 0.2, status: { kind: 'fear', chance: 30, duration: 2 }, desc: 'A sound that routs. Hard control across a whole line.' },
    { name: 'Sonic Boom', learnLevel: 380, type: 'damage', channel: 'voice', target: 'enemy', cooldown: 4, accuracy: 85, power: 30, mana: 26, variance: 0.2, status: { kind: 'confusion', chance: 40, duration: 2 }, effects: { spreadStatus: { kind: 'confusion', targets: 1, chance: 30 } }, desc: 'A heavy burst, and the disorientation carries to whoever stood too close.' },
    ...
    { name: 'Cacophony', learnLevel: 650, type: 'damage', channel: 'voice', target: 'allEnemies', cooldown: 5, accuracy: 82, power: 30, mana: 36, variance: 0.25, status: { kind: 'charm', chance: 22, duration: 2 }, desc: 'A charmed foe turns on its own team. The best status in the game, and the rarest.' },
    ...
    { name: 'Captivate', learnLevel: 200, type: 'damage', channel: 'voice', target: 'enemy', cooldown: 3, accuracy: 88, power: 18, mana: 14, variance: 0.2, effects: { lifesteal: 0.45 }, desc: 'Feeds on adoration and gives nothing back.' },
    ...
    { name: 'Showstopper', learnLevel: 850, type: 'damage', channel: 'voice', target: 'enemy', cooldown: 5, accuracy: 88, power: 47, mana: 36, variance: 0.15, effects: { execute: 0.35 }, desc: 'The closing number, and it closes them.' },
    { name: 'Crescendo', learnLevel: 920, type: 'damage', channel: 'voice', target: 'allEnemies', cooldown: 7, accuracy: 80, power: 57, mana: 50, variance: 0.25, desc: 'A voice AoE finisher. CHA damage exists — it is just rare, and it is late.' },
  ],
}
